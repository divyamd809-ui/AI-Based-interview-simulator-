          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div className="text-center">
              <p className="text-slate-400 text-sm">
                ...
                <Link to="/signup" className="text-indigo-400 font-semibold hover:text-indigo-300 transition-colors inline-flex items-center group">
                  Create one now <ArrowRight className="ml-1 w-4 h-4 transform group-hover:translate-x-1 transition-transform" />
                </Link>
              </p>
            </div>
          </form>
